...
class csadd2caldb(ctools.cscript):
    ...
    def _extract_irfs(self, file, outdir):
        ...
        for member in tar.getmembers():
            ...
            if 'D25' in member.name:
                ...
                suffix = '_D27'
            elif 'MSTs' in member.name:
                suffix = "_" + member.name.split("-")[-2].split(".")[0]
            else:
                suffix = ''
    ...
    def _add_irfs(self):
        ...
        for file in tarfiles:
            ...
            prod       = [e for e in elements if 'prod' in e.lower()][0]
            version    = [e for e in elements if 'v' in e.lower()][0]
